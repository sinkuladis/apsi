<template>
    <div>
        <div v-if="!loading" class="main-body">
            <div class="header">
            ...
            <v-row>
                ...
                <v-col cols="6" class="details">
                    ...
                    <p class="seller"><strong>Wystawiający:</strong> <a @click="redirectToSeller(ad.user.id)">{{ad.user.username}}</a>
                    </p>
        ...
        <div v-if="loading" class="skeleton">
            ...
            <v-skeleton-loader type="table-heading, card, paragraph@2"/>
        </div>
    </div>
</template>
